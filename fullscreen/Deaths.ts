    ...
    export class Deaths {
        ...
        killFlip(thing: ICharacter, extra: number = 0): void {
            ...
            thing.FSM.TimeHandler.addEvent(
                thing.FSM.deaths.killNormal, 70 + extra, thing);
        }
        ...
        killKoopa(thing: IKoopa, big?: boolean): ICharacter {
            ...
            if (thing.jumping || thing.floating) {
                spawn = <ICharacter>thing.FSM.deaths.killReplace(
        ...
        killBowser(thing: IBowser, big?: boolean): void {
            if (big) {
                thing.nofall = false;
                thing.movement = undefined;
                thing.FSM.deaths.killFlip(<any>thing.FSM.deaths.killSpawn(thing));
                return;
            }
            ...
            if (thing.deathcount === 5) {
                ...
                thing.movement = undefined;
                thing.FSM.deaths.killFlip(<any>thing.FSM.deaths.killSpawn(thing), 350);
        ...
        killToShell(thing: ICharacter, big?: number): IShell {
            ...
            spawn = <IShell>thing.FSM.deaths.killSpawn(thing);
        ...
        killNPCs(): void {
            ...
            group = <ICharacter[]>this.FSM.GroupHolder.getGroup("Character");
            ...
            group = <ISolid[]>this.FSM.GroupHolder.getGroup("Solid");
            for (i = group.length - 1; i >= 0; --i) {
        ...
        killBrick(thing: IBrick, other?: ICharacter): void {
            ...
            thing.FSM.TimeHandler.addEvent(
                thing.FSM.animations.animateBrickShards, 1, thing
            );
            thing.FSM.deaths.killNormal(thing);
