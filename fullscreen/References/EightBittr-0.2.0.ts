declare module EightBittr {
     ...
     */
    export interface IEightBittrCustoms {
        /**
...
module EightBittr {
    ...
    export class EightBittr implements IEightBittr {
         ...
         */
        constructor(customs: IEightBittrCustoms = {}) {
            var EightBitter: EightBittr = EightBittr.prototype.ensureCorrectCaller(this),
                constants: any = customs.constants,
                constantsSource: any = customs.constantsSource || EightBitter,
                i: number;
