...
declare module GameStartr {
     ...
     */
    export interface IGameStartrSettings extends EightBittr.IEightBittrCustoms {
        /**
...
module GameStartr {
    ...
    export class GameStartr extends EightBittr.EightBittr implements IGameStartr {
         ...
         * 
         * @param settings   Settings to be added to the instance.
         * @param customs   Any optional custom settings.
         */
        constructor(settings: IGameStartrStoredSettings, customs: IGameStartrSettings = {}) {
            super({
