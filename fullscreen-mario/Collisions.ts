...
module FullScreenMario {
    ...
    export class Collisions {
        ...
        collideShell(thing: ICharacter, other: IShell): void {
            ...
            if (thing.shell) {
                if (other.shell) {
                    return thing.FSM.collisions.collideShellShell(<IShell>thing, other);
                }
            ...
            if (thing.groupType === "Solid") {
                return thing.FSM.collisions.collideShellSolid(<any>thing, other);
            }

            // Hitting a Player
            if (thing.player) {
                return thing.FSM.collisions.collideShellPlayer(<any>thing, <any>other);
            }
            ...
            if (other.xvel) {
                ...
                if (thing.shellspawn) {
                    thing = <any>thing.FSM.deaths.killSpawn(thing);
                }
        ...
        collideBottomBrick(thing: IBrick, other: ICharacter): void {
            if ((<any>other).solid && !thing.solid) {
                return thing.FSM.collisions.collideBottomBrick(<any>other, <any>thing);
            }
            ...
            if ((<IPlayer>other).power > 1 && thing.breakable && !thing.contents) {
                thing.FSM.TimeHandler.addEvent(
                    thing.FSM.deaths.killBrick, 2, thing, other);
                return;
            }
            ...
            if (thing.contents) {
                thing.FSM.TimeHandler.addEvent(
                    function (): void {
                        thing.FSM.animations.animateSolidContents(thing, <any>other);

                        if (thing.contents !== "Coin") {
                            thing.FSM.animations.animateBlockBecomesUsed(<any>thing);
                        } else {
                            if (thing.lastcoin) {
                                thing.FSM.animations.animateBlockBecomesUsed(<any>thing);
                            } else {
        ...
        collideBottomBlock(thing: IBlock, other: IPlayer): void {
            if ((<any>other).solid && !thing.solid) {
                return thing.FSM.collisions.collideBottomBlock(<any>other, <any>thing);
            }
            ...
            thing.FSM.TimeHandler.addEvent(
                thing.FSM.animations.animateSolidContents, 7, thing, other);
        }
